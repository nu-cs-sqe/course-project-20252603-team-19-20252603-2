...
| TC3         | current player given a BURY and reinserts at deck size = 60 (account the drawn card), `playBury(60)` (2 players) | turn passes to player 1; top card moved to index 60                       | no           |
